...
const EXPECTED_FIELDS = ['category', 'latitude', 'longitude', 'description', 'email', 'photo']
...
console.log(
  '✓ relay request contract holds: six fields in order, no city vocabulary, facts in agreement, both sides reading the file',
)
